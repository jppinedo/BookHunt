...
const BookConfigSinglePage = () => {
  ...
  return (
      <Container maxWidth="md" sx={{paddingBottom: "5rem"}}>
        <BookCardSeller book={currentBook} type="view" isSingle={true} />
      </Container>
  )
}

export default BookConfigSinglePage;